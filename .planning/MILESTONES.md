...
- Bidirectional CALM JSON sync engine with direction mutex (no infinite loops)
- 7 extension packs: Core, AWS, GCP, Azure, Kubernetes, AI/Agentic, FluxNova (10 node types)
