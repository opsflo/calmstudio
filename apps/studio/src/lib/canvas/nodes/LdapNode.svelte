...
<div class="node-card" class:selected>
	<div class="icon-container">
		<svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
			<path d="M12 2l8 3.5V11c0 5-3.5 9.7-8 11-4.5-1.3-8-6-8-11V5.5L12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
			<circle cx="12" cy="10" r="2" stroke="currentColor" stroke-width="1.2" />
			<path d="M12 12v4M12 14h2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
		</svg>
	</div>
	<div class="node-content">
		<span class="label">{data.label ?? data.calmId}</span>
		<span class="type-badge">LDAP</span>
	</div>
</div>
...
<style>
	...
	.icon-container {
		...
		height: 36px;
		border-radius: 8px;
		background: var(--node-ldap-border);
		color: var(--node-ldap-stroke);
		flex-shrink: 0;
	}
